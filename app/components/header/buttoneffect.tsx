export const ButtonEffect = () => {
    return (
        <a href={'./cvRenato.pdf'} target="_blank" className="relative inline-flex items-center px-6 sm:px-8 md:px-10 py-2.5 sm:py-3 overflow-hidden text-sm sm:text-md font-medium text-emerald-300 border-2 border-emerald-500 rounded-full hover:text-gray-200 group">
            ...
            <span className="relative">Currículo</span>
        </a>
    )
}